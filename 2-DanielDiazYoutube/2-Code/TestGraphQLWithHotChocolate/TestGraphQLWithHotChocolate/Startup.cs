    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(option =>
                option.UseSqlServer("Data Source=DESKTOP-7OC0NID\\SQLEXPRESS;Initial Catalog=master;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False;Database=DemoGraphQL"));
        ...
        public class Mutation
        {
            ...
            public async Task<Guid> CreateAccount(string name, [Service] ApplicationDbContext context)
            {
